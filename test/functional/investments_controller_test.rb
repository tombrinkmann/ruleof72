...
class InvestmentsControllerTest < ActionController::TestCase
  ...
  test "should create investment" do
    assert_difference('Investment.count') do
      post :create, investment: { interestrate: @investment.interestrate, principle: @investment.principle, years: @investment.years }
    end
  ...
  test "should update investment" do
    put :update, id: @investment, investment: { interestrate: @investment.interestrate, principle: @investment.principle, years: @investment.years }
    assert_redirected_to investment_path(assigns(:investment))
  end
